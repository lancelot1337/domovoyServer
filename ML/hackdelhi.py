...
Original file is located at
    https://colab.research.google.com/drive/1fLlf_q0SZIL7c5kral1GXfI6boe1cXbz
"""
...
checkpoint = ModelCheckpoint("HVAC_model.tf", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
early = EarlyStopping(monitor='val_acc', min_delta=0, patience=2, verbose=1, mode='auto')


model.fit(X_train, y_train, epochs=20, batch_size=200, validation_split=0.05, verbose=1, callbacks=[checkpoint, early])

model_json = model.to_json()
with open("HVAC_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("HVAC_model.h5")
